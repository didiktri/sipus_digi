            ...
            foreach ($data_kategori as $k){
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?= $k->id_kategori;?>"><i class="bi bi-pencil-square"></i></a>
                    <a href="<?= base_url().'admin/hapus_kategori/'. $k->id_kategori;?>" class="btn btn-danger btn-sm">
